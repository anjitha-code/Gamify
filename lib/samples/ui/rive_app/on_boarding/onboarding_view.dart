              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(color: Colors.black.withOpacity(0.7), fontFamily: "Inter", fontSize: 17),
                          ),
                        ],
                      ),
                    ),
                  ...
                  Text(
                    ...
                    style: TextStyle(color: Colors.black.withOpacity(0.7), fontFamily: "Inter", fontSize: 13),
                  ),
                ],
              ),
            ),
