                ...
                Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(20),
                        boxShadow: [
                          BoxShadow(color: RiveAppTheme.shadow.withOpacity(0.3), offset: const Offset(0, 3), blurRadius: 5),
                          BoxShadow(color: RiveAppTheme.shadow.withOpacity(0.3), offset: const Offset(0, 30), blurRadius: 30)
                        ],
                      ...
                      children: [
                        ...
                        Container(
                          decoration: BoxDecoration(
                            boxShadow: [
                              BoxShadow(
                                color: Color.fromARGB(255, 172, 152, 206).withOpacity(0.5),
                                blurRadius: 20,
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "OR",
                                  style: TextStyle(color: Colors.black.withOpacity(0.3), fontSize: 15),
                                ),
                              ),
                              const Expanded(child: Divider()),
                            ],
                        ...
                        const Text("Sign up with Email, Apple or Google", style: TextStyle(color: CupertinoColors.secondaryLabel, fontSize: 15)),
                        const SizedBox(height: 24),
                        Row(
...
InputDecoration authInputStyle(String iconName) {
  return InputDecoration(filled: true, fillColor: Colors.white, enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.black.withOpacity(0.1))), focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.black.withOpacity(0.1))), contentPadding: const EdgeInsets.all(15), prefixIcon: Padding(padding: const EdgeInsets.only(left: 4), child: Image.asset("assets/samples/ui/rive_app/images/$iconName.png")));
}
